...
//      setComponentStatusOK();
    ...
    {
//      setComponentStatus(ComponentStatus.Failed, "Jetty initialization failed (%s)", e);
  ...
  public void stop()
  {
    try
    {
      ...
      jettyServer_.stop();
//      setComponentStatus(ComponentStatus.Stopped, "Shutdown");
    } catch (Exception e) // Jetty throws Exception
    {
//      setComponentStatus(ComponentStatus.Failed, "Jetty stop failed (%s)", e);
      throw new ProgramFault(e);
    }
  }
