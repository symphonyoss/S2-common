...
public class AbstractIndentedWriter<T extends AbstractIndentedWriter<T>> extends PrintWriter
{
  ...
  {
    private Writer       writer__;
    private OutputStream out__;
    private boolean      closeFlag__;
    private int          tabSize__      = 2;
    private String       indentString__ = "  ";
    ...
    public Builder<T> withCloseUnderlyingWriter(boolean closeFlag)
    {
      closeFlag__ = closeFlag;
      return this;
    }

    public Builder<T> withTabSize(int tabSize)
    {
      tabSize__ = tabSize;
      StringBuilder b = new StringBuilder();

      for (int i = 0; i < tabSize__; i++)
        b.append(' ');

      indentString__ = b.toString();
    ...
    {
      if(writer__ == null)
        writer__ = new OutputStreamWriter(out__);
    ...
    {
      return indentString__;
    }

    public abstract T build();
  }

  public AbstractIndentedWriter(Writer out, boolean closeFlag, int tabSize, String indentString)
  {
    super(out instanceof CountedWriter ? out : new CountedWriter(out, closeFlag), closeFlag = true);
  ...
  /**
   * Add a row to an aligned block, each Object represents a piece of text which
   * should be aligned.
   * 
   * @param args
   *          Variable number of values to align.
   */
  ...
  /**
   * Prints the aligned block, with all strings aligned in columns dependent on
   * the order in which they were declared in Align
   * 
   * @param separator
   *          text added to the end of each line except the last line
   * @param terminator
   *          text added to the end of the last line of the block
   */
  ...
  /**
   * Prints a string, an open curly bracket on its own line and indents the
   * following line
   * 
   * @param s
   *          preceding string
  ...
  /**
   * outdents the current line and prints a close curly bracket on the next
   * line, followed by a string
   * 
   * @param s
   *          succeeding string
   */
  ...
  /**
   * Ends one block (outdent followed by a close curly bracket on the following
   * line) prints a string on its own line and begins a new block (open curly
   * bracket followed by an indent on the following line
   * 
   * @param s
   *          intermediate string
   */
   ...
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
   * @param b
   ...
   *          magnitude of the indent (number of tab spaces)
   * @param f
   *          floating point number to be printed
   */
  ...
  /**
   * Indent the current line and print a boolean on the same line, then print a
   * line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print a character on the same line, then print
   * a line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print a character array on the same line, then
   * print a line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print a double on the same line, then print a
   * line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print an integer on the same line, then print a
   * line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print an object on the same line, then print a
   * line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print a string on the same line, then print a
   * line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
  ...
  /**
   * Indent the current line and print a long integer on the same line, then
   * print a line break
   * 
   * @param tempIndent
   *          magnitude of the indent (number of tab spaces)
   ...
   * 
   * @param f
   *          floating point number to print
   */
  @Override
   ...
   * 
   * @param pattern
   *          A format string as per String.format(), a null value is equivalent
   *          to ""
   * @param arguments
   ...
   * 
   * @param indent
   *          The number of indent stops to apply at the start of a line.
   * @param pattern
   *          A format string as per String.format(), a null value is equivalent
   *          to ""
   * @param arguments
