...
public abstract class AbstractXmlWriter<T extends AbstractXmlWriter<T>> extends AbstractIndentedWriter<T>
{
  private   Stack<String>   elementStack_ = new Stack<String>();
  
  public AbstractXmlWriter(Writer out, boolean closeFlag, int tabSize, String indentString)
  {
