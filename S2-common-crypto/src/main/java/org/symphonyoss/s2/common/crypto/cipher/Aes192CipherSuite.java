...
/* package */ class Aes192CipherSuite extends AesCipherSuite
{
	public Aes192CipherSuite(SymmetricCipher id) throws NoSuchAlgorithmException, NoSuchProviderException
	{
		super(id, AES_CBC_PKCS7Padding_CIPHER, 192);
	}
}
