...
/* package */ class Aes128CipherSuite extends AesCipherSuite
{
	public Aes128CipherSuite(SymmetricCipher id) throws NoSuchAlgorithmException, NoSuchProviderException
	{
		super(id, AES_CBC_PKCS7Padding_CIPHER, 128);
	}
}
