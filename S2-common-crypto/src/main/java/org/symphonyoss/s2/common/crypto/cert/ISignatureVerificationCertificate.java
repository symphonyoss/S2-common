...
public interface ISignatureVerificationCertificate extends ICertificate
{
  ...
  void verifySignature(ByteString signature, byte[] payload) throws SignatureVerificationException;
  void verifySignature(byte[] signature, byte[] payload) throws SignatureVerificationException;
}
